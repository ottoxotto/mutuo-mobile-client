...
class ITBodyCalcRataAnniCalcLayout extends StatefulWidget {
  ...
  @override
  State<ITBodyCalcRataAnniCalcLayout> createState() =>
      _ITBodyCalcRataAnniCalcLayoutState();
}

class _ITBodyCalcRataAnniCalcLayoutState
    extends State<ITBodyCalcRataAnniCalcLayout> {
  String entry = "";
