...
class DEBodyCalcRataAnniCalcLayout extends StatefulWidget {
  final String finalResponse;
  final String language;


  const DEBodyCalcRataAnniCalcLayout({Key? key, required this.finalResponse, required this.language})
      : super(key: key);

  @override
  State<DEBodyCalcRataAnniCalcLayout> createState() =>
      _DEBodyCalcRataAnniCalcLayoutState();
}

class _DEBodyCalcRataAnniCalcLayoutState
    extends State<DEBodyCalcRataAnniCalcLayout> {
  String entry = "";
