...
class ITCalcRataAnniCalcPage extends StatefulWidget {
  ...
  const ITCalcRataAnniCalcPage({Key? key, required this.language}) : super(key: key);
...
class ITCalcRataAnniCalcPageState extends State<ITCalcRataAnniCalcPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ITBodyCalcRataAnniCalcLayout(finalResponse: finalResponse, language: currentLanguage),
