...
class ITCalcRataAnniCalcPage extends StatefulWidget {
  const ITCalcRataAnniCalcPage({Key? key}) : super(key: key);

  @override
  State<ITCalcRataAnniCalcPage> createState() => ITCalcRataAnniCalcPageState();
}

class ITCalcRataAnniCalcPageState extends State<ITCalcRataAnniCalcPage> {
  List<bool> formBool = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ITBodyCalcRataAnniCalcLayout(finalResponse: finalResponse),
              ...
              onPressed: () async {
                ...
                if (eq(formBool, [true, true, true, true])) {
                  ...
                  setState(() {
                    ...
                    ITBodyCalcRataAnniCalcLayout(finalResponse: finalResponse);
                  });
                }
                formBool.clear();
              },
